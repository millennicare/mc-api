...
Revision ID: e03a9eb204d3
Revises: a159570c86c3
Create Date: 2025-10-08 10:03:38.563618
...
revision: str = "e03a9eb204d3"
down_revision: Union[str, Sequence[str], None] = "a159570c86c3"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("careseeker_id", sa.String(length=36), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("caregiver_information_id", sa.String(length=36), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("careseeker_information_id", sa.String(length=36), nullable=False),
        sa.Column("specialty_id", sa.String(length=36), nullable=False),
        sa.ForeignKeyConstraint(
